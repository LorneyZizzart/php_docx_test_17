<?php
// replace text variables (placeholders) with new text in headers and footers using ${ and } as wrapping symbols from an existing DOCX

require_once __DIR__ . '/../../../classes/CreateDocx.php';

$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateSimpleText_header_footer_symbols.docx');
...
$docx->createDocx(__DIR__ . '/example_replaceVariableByText_4');
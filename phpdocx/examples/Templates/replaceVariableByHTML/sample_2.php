...
$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateHTML_symbols.docx');
...
<div>
    ...
    <p></p>
    <p>At NarceaLabs we are committed to producing an effective, efficient and high quality development. Our priorities are: <strong>usability, accessibility, indexability and updating</strong>, because every website is a living project.</p>
...
$docx->replaceVariableByHTML('ADDRESS', 'inline', '<p style="font-family: verdana; font-size: 11px">phpdocx by <b>NarceaLabs</b></p>');
...
$docx->createDocx(__DIR__ . '/example_replaceTemplateVariableByHTML_2');
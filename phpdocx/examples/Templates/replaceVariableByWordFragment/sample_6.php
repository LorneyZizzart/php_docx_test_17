...
$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateWordFragment_1_symbols.docx');
...
$image->addImage(array('src' => __DIR__ . '/../../img/image.png' , 'scaling' => 50, 'float' => 'right', 'textWrap' => 1));
...
$docx->createDocx(__DIR__ . '/example_replaceVariableByWordFragment_6');
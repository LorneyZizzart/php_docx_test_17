<?php
// replace text variables (placeholders) with WordFragments in headers, footers and document doing inline replacements from an existing DOCX

require_once __DIR__ . '/../../../classes/CreateDocx.php';

$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateWordFragmentsTarget_symbols.docx');
$docx->setTemplateSymbol('${', '}');

$imageHeader = new WordFragment($docx);
$imageHeader->addImage(array('src' => __DIR__ . '/../../files/image.png', 'scaling' => 20));
...
$imageBody->addImage(array('src' => __DIR__ . '/../../files/image.png'));

$imageFooter = new WordFragment($docx);
$imageFooter->addImage(array('src' => __DIR__ . '/../../files/image.png', 'scaling' => 50));
...
$docx->createDocx(__DIR__ . '/example_replaceVariableByWordFragment_7');
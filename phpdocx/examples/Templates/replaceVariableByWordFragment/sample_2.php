...
$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateWordFragment_2.docx');
...
$image->addImage(array('src' => __DIR__ . '/../../img/image.png' , 'scaling' => 10));
...
$docx->createDocx(__DIR__ . '/example_replaceVariableByWordFragment_2');
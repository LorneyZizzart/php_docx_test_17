<?php
// replace a text variable (placeholder) with WordML from an existing DOCX

require_once __DIR__ . '/../../../classes/CreateDocx.php';

$docx = new CreateDocxFromTemplate(__DIR__ . '/../../files/TemplateWordML.docx');
...
$docx->createDocx(__DIR__ . '/example_replaceVariableByWordML_1');
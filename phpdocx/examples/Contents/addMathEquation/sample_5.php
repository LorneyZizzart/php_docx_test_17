...
$docx->addMathEquation($mathML, 'mathml', array('align' => 'left', 'bold' => true));

$docx->addMathEquation($mathML, 'mathml', array('align' => 'left', 'bold' => false, 'italic' => false));
...
$docx->createDocx(__DIR__ . '/example_addMathML_5');
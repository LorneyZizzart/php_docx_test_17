...
$toc = new WordFragment($docx);
$toc->addTableContents(array('autoUpdate' => true), $legend, __DIR__ . '/../../files/crazyTOC.docx');
...
$docx->createDocx(__DIR__ . '/example_addTableContents_2');
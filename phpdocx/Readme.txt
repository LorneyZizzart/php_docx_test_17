...
- Performance:
    ...
    · Faster insertion of text content.
    · Improved parse mode performance.
- New method to add barcode fields: addBarcode.
...
- HTML Extended (Premium licenses):
    ...
    · Normalized hightlight dark and light color values when using data-highlight.
...
- Get the document statistics based on the native conversion plugin (Advanced and Premium licenses only).
...
- JavaScript API (Premium licenses):
    ...
    · Handle w:end tag in WordFragments.
- PDFUtilities (Advanced and Premium licenses):
...
- Native DOCX to HTML (Advanced and Premium licenses):
    ...
    · Don't apply margin-top in textboxes that use absolute positions.
- Native DOCX to PDF (Advanced and Premium licenses):
    · Don't apply margin-top in textboxes that use absolute positions.

...
class Docx2Text
{
    ...
    public function extract($filename = '')
    {
        ...
        $this->domDocument = $this->xmlUtilities->generateDomDocument($this->_document);
    ...
    {
        if (file_exists(__DIR__ . '/DOCXStructureTemplate.php') && $filename instanceof DOCXStructure) {
            $this->docx = $filename;
        } else {
    ...
    private function loadEndNote()
    {
        if (empty($this->endnotes)) {
            ...
            if (!empty($this->_endnote)) {
                $domDocument = $this->xmlUtilities->generateDomDocument($this->_endnote);
    ...
    private function loadFootNote()
    {
        if (empty($this->footnotes)) {
            ...
            if (!empty($this->_footnote)) {
                $domDocument = $this->xmlUtilities->generateDomDocument($this->_footnote);
    ...
    private function listNumbering()
    {
        ...
        if (!empty($this->_numbering)) {
            ...
            $domDocument = $this->xmlUtilities->generateDomDocument($this->_numbering);
    ...
    private function loadRelations()
    {
        if (empty($this->relations)) {
            ...
            $domDocument = $this->xmlUtilities->generateDomDocument($this->_relations);

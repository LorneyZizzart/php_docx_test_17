...
class CreateTextBox extends CreateElement
{
    ...
    public function createTextBox($textboxContent, $options = array())
    {
        ...
        if ($options['height'] == 'auto' || isset($options['textboxStyle'])) {
            $this->_xml .= ' style="';
            if ($options['height'] == 'auto') {
                $this->_xml .= 'mso-fit-shape-to-text:t;';
            }
            if (isset($options['textboxStyle'])) {
                $this->_xml .= $options['textboxStyle'] . ';';
            }
            $this->_xml .= '"';
        }
        $this->_xml .= ' >';

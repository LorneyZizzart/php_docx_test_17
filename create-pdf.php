...
$wordFile = $documentsPath . '/create-pdf.docx';
...
if (PHP_OS_FAMILY === 'Darwin') {
    ...
    $libreOffice = 'C:\\Program Files\\LibreOffice\\program\\soffice.exe'; // Windows
} else {
    throw new Exception(
...
$pdfFile = $documentsPath . '/create-pdf.pdf';
